...
from orchestrator.dashboard import history, k8s
...
async def logs(name: str, lines: int = Query(100, ge=1, le=1000)) -> dict[str, Any]:
    return k8s.pod_logs(name, lines=lines)
